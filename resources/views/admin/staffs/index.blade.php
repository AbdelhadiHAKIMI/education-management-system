        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-3 space-x-reverse">
                    <a href="{{ route('admin.staffs.create') }}" class="flex items-center space-x-2 space-x-reverse bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg text-white">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-right">التخصص الجامعي</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-gray-500">{{ $staff->univ_specialty ?? '-' }}</td>
                            <td class="px-6 py-4">
                                <div class="flex space-x-2 space-x-reverse">
                                    <a href="{{ route('admin.staffs.edit', $staff->id) }}" class="text-blue-600 hover:text-blue-800">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('admin.staffs.destroy', $staff->id) }}" method="POST" onsubmit="return confirm('هل أنت متأكد من حذف هذا المؤطر؟');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @if($staffs->isEmpty())
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500">لا يوجد مؤطرون مسجلون</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
