                    ...
                    <div class="flex justify-between items-center mx-auto px-4 py-3 container">
                        ...
                        <div class="flex items-center space-x-6 space-x-reverse">
                            <div class="group relative">
                                <button
                                    class="flex items-center space-x-2 space-x-reverse bg-blue-700 px-3 py-1 rounded-lg">
                                    <i class="fas fa-calendar-alt"></i>
                                    <span>2023/2024</span>
                                    <i class="text-xs fas fa-chevron-down"></i>
                                </button>
                                <div
                                    class="hidden group-hover:block right-0 z-10 absolute bg-white shadow-lg mt-2 rounded-md w-48">
                                    <div class="py-1">
                                        <div class="bg-gray-100 px-4 py-2 font-semibold text-dark">السنوات الدراسية
                                        </div>
                                        <a href="#" class="block hover:bg-gray-100 px-4 py-2 text-dark">
                                            <span class="font-medium">2023/2024</span>
                                            <span
                                                class="bg-green-100 mr-2 px-2 py-1 rounded-full text-green-800 text-xs">نشطة</span>
                                        </a>
                                        <a href="#"
                                            class="block hover:bg-gray-100 px-4 py-2 text-dark">2022/2023</a>
                                        <a href="#"
                                            class="block hover:bg-gray-100 px-4 py-2 text-dark">2021/2022</a>
                    ...
                    <main class="flex-1 p-8">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div class="flex space-x-3 space-x-reverse">
                                <button
                                    class="flex items-center space-x-2 space-x-reverse bg-white hover:bg-gray-50 px-4 py-2 border border-gray-300 rounded-lg text-gray-700">
                                ...
                                <div class="flex justify-between items-center">
                                    <div>
                                        ...
                                        <h3 class="font-bold text-2xl">
                                            {{ Program::where('is_active', true)->count() }}</h3>
                                    </div>
                        ...
                        @forelse($programs as $program)
                            <div class="bg-white shadow-md mb-8 p-6 border-accent border-r-4 rounded-lg">
                                <div class="flex justify-between items-center">
                                    <div>
                                        <h2 class="font-semibold text-dark text-xl">
                                            {{ $program->name ?? 'اسم البرنامج غير متوفر' }}</h2>
                                        ...
                                        <div class="flex items-center space-x-4 space-x-reverse mt-3">
                                            <div>
                                                ...
                                                <p class="font-medium">
                                                    {{ \Carbon\Carbon::parse($program->start_date ?? '2023-09-05')->translatedFormat('d F Y') }}
                                                </p>
                                            </div>
                                            <div>
                                                <span class="text-gray-500 text-sm">تاريخ الانتهاء</span>
                                                <p class="font-medium">
                                                    {{ \Carbon\Carbon::parse($program->end_date ?? '2024-05-30')->translatedFormat('d F Y') }}
                                                </p>
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex space-x-3 space-x-reverse">
                                        <button
                                            class="flex items-center bg-primary hover:bg-blue-700 px-4 py-2 rounded-lg text-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-4 text-center text-gray-500">لا توجد برامج متاحة
                                    حالياً.</td>
                            </tr>
                        @endforelse
